...
//
//        String str1 = "Hello " + 2 + " something" + new Object().toString();
        String str = "Epam";

        //**************

        // Concatenation of two strings
        System.out.println(String.format("My future Company name is %s", str));
    ...
    private static void format(){
        ...
        formatter.format("");
        Formatter formatterLocalized = new Formatter(Locale.CANADA);
